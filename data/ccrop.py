...
VOC_CLASSES = ('bellpepper', 'chilipepper')

CLASS_NAME_MAPPING = {
    "ChiliPepper": "chilipepper",
    "BellPepper": "bellpepper"  # Add more mappings if needed
}
...
def save_results(all_boxes,
    ...
    for class_i, class_name in enumerate(VOC_CLASSES):
        ...
        text = 'Writing {:s} CCROP results file'.format(class_name)
...
def parse_annotation(file_name):
    """Parse a CCROP annotation in VOC XML format."""
