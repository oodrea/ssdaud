...
class SSDEfficientNet(nn.Module):
    ...
    Assumes the backbone returns 6 features maps with channels 40, 112, 160, 224, 288, 640.
    """
    def __init__(self, 
                 mode, 
                 backbone, 
...
def build_SSDEfficientNet(mode, new_size, anchors, class_count):
    ...
    mbox_config = [4, 6, 6, 6, 6, 4]  # One per feature map; should match anchor config last line e.g [2,3] = 6 ; [2] = 4
